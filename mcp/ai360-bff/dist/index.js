...
async function fetchBff(path, init) {
...
const TOOLS = [
    {
        name: 'bff_health',
        description: 'Ping ai360 BFF GET /api/health. Use before search/fusion to check local api or Render.',
        inputSchema: {
            type: 'object',
            properties: {},
        },
    ...
    {
        name: 'bff_search',
        description: 'Search products via GET /api/search?q=... Optional wbPage for Wildberries pagination.',
        inputSchema: {
            type: 'object',
            properties: {
                query: {
    ...
    },
    {
        ...
        description: 'Create animal hybrid via POST /api/animal-fusion. May take 1–6 min on Stable Horde queue.',
        inputSchema: {
            type: 'object',
            properties: {
    ...
    {
        name: 'bff_wb_image',
        description: 'Check Wildberries image proxy GET /api/wb-image/:nmId (follows redirect, returns status).',
        inputSchema: {
            type: 'object',
            properties: {
                nmId: {
